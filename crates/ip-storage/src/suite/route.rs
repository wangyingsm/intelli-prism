...
pub(crate) async fn a_route_round_trips(store: &impl AnyStore) {
...
pub(crate) async fn a_route_names_the_api_it_serves(store: &impl AnyStore) {
...
pub(crate) async fn writing_the_same_route_key_replaces_its_target(store: &impl AnyStore) {
    store
...
pub(crate) async fn a_route_key_carries_every_part_of_the_tuple(store: &impl AnyStore) {
...
pub(crate) async fn every_protocol_survives_a_round_trip(store: &impl AnyStore) {
    for protocol in [
        Protocol::Http,
        Protocol::Https,
        Protocol::Ws,
...
pub(crate) async fn removing_a_route_that_is_absent_reports_it_missing(store: &impl AnyStore) {
...
pub(crate) async fn a_route_may_stand_for_several_endpoints(store: &impl AnyStore) {
...
pub(crate) async fn rewriting_a_route_replaces_its_whole_endpoint_list(store: &impl AnyStore) {
